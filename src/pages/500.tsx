...
export default function Custom500() {
  return (
    <Main meta={<Meta title="500" description="500 Error Page" />}>
      <div className="min-h-screen items-center justify-center bg-white px-4 sm:px-6 sm:py-24 md:grid md:place-items-center lg:px-8">
            ...
            <div className="sm:ml-6">
              <div className="sm:border-l sm:border-gray-200 sm:pl-6">
                ...
                <p className="mt-1 text-base text-gray-500">
                  Please come back Homepage or try later!
                </p>
              </div>
              <div className="mt-10 flex space-x-3 sm:border-l sm:border-transparent sm:pl-6">
                <Link href="/">
                  <a
                    href="/commitlint.config.js"
